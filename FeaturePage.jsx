...
function FeaturePage() {
  ...
  useEffect(() => {
    document.title = language === 'ar' ? 'صراع داخلي - أبتاون فيلم' : 'Inner Conflict – Uptown Film';
      ...
      <main className="pt-24 px-6 sm:px-12 lg:px-24 space-y-24">
        ...
        >
          ...
          <div className="lg:w-1/2 space-y-4">
            ...
            <p className={`text-gray-300 leading-relaxed ${isRTL ? 'font-arabic' : 'font-sans'}`}>
              {language === 'ar'
        ...
        >
          ...
          <div className="lg:w-1/2 space-y-4">
            ...
            >
              {language === 'ar' ? 'الرسالة الاجتماعية والتعليمية' : 'A Social and Educational Message'}
            </h2>
            <p className={`text-gray-300 leading-relaxed ${isRTL ? 'font-arabic' : 'font-sans'}`}>
              {language === 'ar'
